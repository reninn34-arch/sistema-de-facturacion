...
| **Facturación Recurrente / Contratos** | Se creó `RecurringInvoices.tsx` para programar contratos de servicios y arriendos con frecuencias (semanal, mensual, anual), estado del contrato (activa/pausada) y botón de emisión masiva en lote para el período activo. |
