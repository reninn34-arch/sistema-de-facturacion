        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex items-start gap-3 flex-1">
              <div className="w-10 h-10 rounded-xl bg-[#0EA5E9]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                <ShieldCheckIcon className="w-5 h-5 text-[#0EA5E9]" />
              </div>
              <div className="text-sm text-slate-600 leading-relaxed font-medium">
                {message}{' '}
                <a href={privacyUrl} className="text-[#0EA5E9] font-bold hover:underline">Politica de Privacidad</a>
                {' '}y{' '}
                <a href={legalUrl} className="text-[#0EA5E9] font-bold hover:underline">Terminos Legales</a>.
              </div>
            </div>
