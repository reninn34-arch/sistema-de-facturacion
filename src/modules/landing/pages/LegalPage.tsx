...
<p>Al acceder y utilizar el sistema Ecuafact Pro, usted acepta expresamente los presentes Términos y Condiciones. Si no está de acuerdo con alguno de estos términos, le recomendamos no utilizar nuestros servicios.</p>

<h3>2. Descripción del Servicio</h3>
<p>Ecuafact Pro es un sistema de facturación electrónica que permite a personas naturales y jurídicas en Ecuador emitir comprobantes electrónicos autorizados por el Servicio de Rentas Internas (SRI). El servicio incluye la generación de facturas, notas de crédito, retenciones, guías de remisión y liquidaciones de compra, así como módulos de inventario, producción y reportes tributarios.</p>

<h3>3. Registro y Cuenta</h3>
<p>Para utilizar nuestros servicios, debe crear una cuenta proporcionando información veraz, precisa y completa. Usted es responsable de mantener la confidencialidad de su contraseña y de todas las actividades que ocurran bajo su cuenta. Ecuafact Pro no se hace responsable por pérdidas o daños derivados del uso no autorizado de su cuenta.</p>
...
<p>Usted se compromete a utilizar Ecuafact Pro únicamente para fines lícitos y de conformidad con la legislación ecuatoriana vigente. Está prohibido: (a) utilizar el sistema para emitir comprobantes falsos o fraudulentos; (b) intentar acceder a datos de otros usuarios; (c) realizar ingeniería inversa sobre el software; (d) utilizar el sistema para fines que violen derechos de terceros.</p>

<h3>6. Propiedad Intelectual</h3>
<p>Todo el contenido, software, diseño, marcas y derechos de propiedad intelectual relacionados con Ecuafact Pro son de nuestra exclusiva propiedad o están debidamente licenciados. El uso de nuestros servicios no le otorga ningún derecho de propiedad sobre los mismos.</p>

<h3>7. Limitación de Responsabilidad</h3>
<p>Ecuafact Pro se proporciona "tal cual" y "según disponibilidad". No garantizamos que el servicio sea ininterrumpido o libre de errores. Nuestra responsabilidad total por cualquier reclamo relacionado con el servicio no excederá el monto pagado por usted en los últimos 12 meses. No seremos responsables por pérdidas indirectas, incidentales o consecuentes.</p>
...
<p>Para cualquier consulta sobre privacidad o para ejercer sus derechos, contacte a nuestro Delegado de Protección de Datos en: privacidad@ecuafact.pro</p>`,
  },
  cookies: {
...
<p><strong>Cookies Esenciales (Técnicas):</strong> Son necesarias para el funcionamiento del sistema de facturación. Permiten la autenticación de usuarios, el mantenimiento de sesiones seguras y la protección contra accesos no autorizados. Sin estas cookies, Ecuafact Pro no puede funcionar correctamente.</p>
...
<p>Ecuafact Pro no utiliza cookies de terceros para publicidad ni para seguimiento con fines comerciales. Las únicas cookies de terceros presentes son las necesarias para el procesamiento de pagos (PayPal) cuando usted realiza una suscripción.</p>
...
<p>Usted puede configurar su navegador para rechazar todas o algunas cookies, o para que le avise cuando se envía una cookie. Tenga en cuenta que si desactiva las cookies esenciales, no podrá iniciar sesión ni utilizar las funciones principales de Ecuafact Pro.</p>
...
<h3>7. Contacto</h3>
<p>Si tiene preguntas sobre nuestra política de cookies, contáctenos en: privacidad@ecuafact.pro</p>`,
  },
};
...
const LegalPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      {/* ===== TOP INFO BAR ===== */}
      <div className="bg-[#003ACC] text-white text-xs font-medium">
      ...
      <header className="bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <a
            href="/"
            className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-[#0057FF] transition-colors"
          >
      ...
      <section className="bg-gradient-to-br from-[#003ACC] via-[#003ACC] to-[#0057FF] py-12 lg:py-16 relative overflow-hidden">
