              ...
              <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#0057FF]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                      <PhoneIcon className="w-6 h-6 text-[#0057FF]" />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">Teléfono</p>
                      <a href={`tel:${contact.phone.replace(/\s/g, '')}`} className="text-lg font-extrabold text-slate-800 hover:text-[#0057FF] transition-colors">{contact.phone}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#0057FF]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                      <EnvelopeIcon className="w-6 h-6 text-[#0057FF]" />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">Email</p>
                      <a href={`mailto:${contact.email}`} className="text-lg font-extrabold text-slate-800 hover:text-[#0057FF] transition-colors">{contact.email}</a>
                    </div>
                  </div>
                  {contact.address && (
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-[#0057FF]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                        <MapPinIcon className="w-6 h-6 text-[#0057FF]" />
                      </div>
                      <div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#0057FF]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                      <ClockIcon className="w-6 h-6 text-[#0057FF]" />
                    </div>
                    <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-4 bg-[#F8F9FC] rounded-2xl font-bold text-sm outline-none border-2 border-transparent focus:border-[#0057FF] transition-colors"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-4 bg-[#F8F9FC] rounded-2xl font-medium text-sm outline-none border-2 border-transparent focus:border-[#0057FF] transition-colors resize-none"
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full py-4 bg-[#0057FF] text-white rounded-2xl font-bold text-sm hover:bg-[#003ACC] transition-all shadow-lg shadow-[#0057FF]/25 hover:-translate-y-0.5"
                  >
                    Enviar Mensaje
                  </button>
                </form>
