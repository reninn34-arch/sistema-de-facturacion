  ...
  return (
        ...
        <div className="relative z-50 w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-2xl p-8 text-center">
          ...
          <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
            <p className="text-sm text-amber-800 dark:text-amber-200">
              📧 Se notificará a su correo electrónico una vez approveda la transferencia.
            </p>
          </div>
          <button
            onClick={() => {
    ...
    <div className={`min-h-screen flex items-center justify-center p-4 ${isExpired ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900' : 'bg-slate-50 dark:bg-slate-900'}`}>
      ...
      <div className={`relative z-50 w-full max-w-4xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden ${isExpired ? '' : 'mt-8'}`}>
        {/* Header de alerta */}
        <div className={`p-6 text-white ${isExpired ? 'bg-gradient-to-r from-red-600 to-red-700' : 'bg-gradient-to-r from-blue-600 to-blue-700'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-bold text-sm focus:border-blue-500 outline-none"
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl p-4 text-center hover:border-blue-500 transition-colors">
                      {paymentProofPreview ? (
              ...
              {paymentMethod === 'PAYPAL' && (
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                    <p className="text-sm text-blue-800 dark:text-blue-300 mb-2 text-center">
              ...
              <div className="mt-6 p-4 bg-slate-900 dark:bg-slate-800 rounded-xl">
                ...
                <div className="border-t border-slate-700 pt-2 mt-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-black text-blue-400">${currentPlan.price.toFixed(2)}</span>
                  </div>
                </div>
              </div>
              ...
              {paymentMethod !== 'PAYPAL' && (
                <button
                  ...
                  className="w-full mt-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-black uppercase tracking-widest rounded-xl shadow-lg shadow-blue-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isProcessing ? (
                    <>
