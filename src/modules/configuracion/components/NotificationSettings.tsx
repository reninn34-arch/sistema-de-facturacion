                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-sm font-bold text-blue-800">
                        <div className="bg-white/60 p-3 rounded-xl">
                          <p className="font-black mb-1">📮 OPCIÓN 1: SMTP (Gmail, Outlook, etc.)</p>
                          <ul className="list-disc ml-5 space-y-1">
                            <li>Gmail: smtp.gmail.com:587</li>
                            <li>Outlook: smtp-mail.outlook.com:587</li>
                            <li>Yahoo: smtp.mail.yahoo.com:587</li>
                          </ul>
                          <p className="mt-2 text-xs text-blue-600">⚠️ Gmail: necesitas crear contraseña de aplicación</p>
                        </div>
                        <div className="bg-white/60 p-3 rounded-xl">
                          <p className="font-black mb-1">🚀 OPCIÓN 2: SendGrid (Profesional)</p>
                          <ul className="list-disc ml-5 space-y-1">
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-600 mt-1 font-bold">
                          📌 Gmail: <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener" className="underline">Crear contraseña de aplicación</a>
                        </p>
                      </div>
                    </>
                  )}
                  ...
                  {localSettings.emailProvider === 'sendgrid' && (
                    <>
                      <div>
                        ...
                        />
                        <p className="text-xs text-blue-600 mt-1 font-bold">
                          📌 Obtén tu API Key en: <a href="https://app.sendgrid.com/settings/api_keys" target="_blank" rel="noopener" className="underline">SendGrid Dashboard</a>
                        </p>
                      </div>
                    </>
                  )}
              ...
              <>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-sm font-bold text-emerald-800">
                        <div className="bg-white/60 p-3 rounded-xl">
                          <p className="font-black mb-1">🌐 OPCIÓN 1: WhatsApp Cloud API (GRATIS)</p>
                        ...
                        <div className="bg-white/60 p-3 rounded-xl">
                          <p className="font-black mb-1">🔌 OPCIÓN 2: Twilio (FÁCIL)</p>
                          <ol className="list-decimal ml-5 space-y-1">
                      ...
                      >
                        {showWhatsAppGuide ? '👆 Ocultar' : '👇 Ver Tutorial'}
                      </button>
                    </div>
                  </div>
                </div>
                ...
                {showWhatsAppGuide && (
                  <div className="bg-white border-2 border-emerald-300 p-6 rounded-2xl">
                    <h4 className="font-black mb-4">📖 Tutorial Detallado</h4>
