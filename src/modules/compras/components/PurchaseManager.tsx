  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => setShowForm(true)} className="bg-sky-500 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl hover:scale-105 transition-all flex items-center gap-2">
        ...
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[400] flex items-start justify-center p-4 pt-12 overflow-y-auto">
          <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-3xl overflow-hidden animate-in zoom-in duration-200">
            <div className="flex justify-between items-center p-6 border-b border-slate-100">
              ...
              <button onClick={resetForm} className="p-2 hover:bg-slate-100 rounded-xl text-slate-500 font-bold">✕</button>
            </div>
            ...
            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button onClick={addItem} className="text-xs font-bold text-sky-500 hover:text-sky-600 flex items-center gap-1">
                  ...
                  <div className="space-y-2">
                    {items.map((item, idx) => (
                      <div key={idx} className="flex gap-2 items-center bg-slate-50 p-3 rounded-xl">
                        ...
                        <button onClick={() => removeItem(idx)} className="text-slate-400 hover:text-rose-500 p-1">✕</button>
                      </div>
                    ))}
                  </div>
                )}
