...
const Login = React.lazy(() => import('./modules/autenticacion/pages/Login'));
const ClientLogin = React.lazy(() => import('./modules/autenticacion/pages/ClientLogin'));
const ClientDashboard = React.lazy(() => import('./modules/clientes/pages/ClientDashboard'));
const ResetPassword = React.lazy(() => import('./modules/autenticacion/pages/ResetPassword'));
const VerifyEmail = React.lazy(() => import('./modules/autenticacion/pages/VerifyEmail'));
const SubscriptionPage = React.lazy(() => import('./modules/saas/pages/SubscriptionPage'));
const LandingPage = React.lazy(() => import('./modules/landing/pages/LandingPage'));
const AyudaPage = React.lazy(() => import('./modules/landing/pages/AyudaPage'));
const ContactoPage = React.lazy(() => import('./modules/landing/pages/ContactoPage'));
const LegalPage = React.lazy(() => import('./modules/landing/pages/LegalPage'));
const BlogPage = React.lazy(() => import('./modules/landing/pages/BlogPage'));
