...
const defaultPlans = [
  ...
  },
  {
    ...
    period: 'indefinido',
    durationDays: 36500,
    features: ['Empresas ilimitadas', 'Facturas ilimitadas', 'Asistente IA', 'Soporte 24/7', 'API Access', 'Gestión de distribuidores'],
    maxBusinesses: 999,
  ...
  async createPlan(data) {
    ...
    return prisma.subscriptionPlan.create({
      data: {
        ...
        priceWithTax: price ? Math.round(parseFloat(price) * 1.15 * 100) / 100 : 0,
  ...
  async updatePlan(id, data) {
    ...
    return prisma.subscriptionPlan.update({
      ...
      data: {
        ...
        price: finalPrice,
        priceWithTax: Math.round(finalPrice * 1.15 * 100) / 100,
